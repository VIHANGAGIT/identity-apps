...
const useGetRegistrationFlowBuilderResources = <Data = Resources, Error = RequestErrorInterface>(
    ...
    // Executors contributed by extensions deployed on the server. Not known at build time, so they are
    // appended to the palette at runtime rather than declared in steps.json.
