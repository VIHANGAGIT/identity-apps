...
/**
 * Props interface of {@link ExtensionExecution}.
 */
 ...
 *
 * The console has no build time knowledge of these executors, so the label and icon are resolved from
 * the flow metadata at render time, the same way {@link FlowExtensionExecution} resolves its selected
 * connection.
 *
 * @param props - Props injected to the component.
 * @returns The ExtensionExecution component.
 */
const ExtensionExecution = ({
    ...
    /*
     * A contributed icon can point anywhere, including at a path this console does not serve, so fall
     * back to the generic extension icon rather than rendering a broken image on the canvas.
     */
