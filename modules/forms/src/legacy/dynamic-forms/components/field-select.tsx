 ...
 *
 * Unlike {@link FieldInput}, only the props the underlying adapter understands are forwarded to it,
 * since the dynamic form spreads every key of the field definition (`maxLength`, `width`, `index`,
 * etc.) onto the field and those are not valid DOM attributes of a `Select`.
 *
